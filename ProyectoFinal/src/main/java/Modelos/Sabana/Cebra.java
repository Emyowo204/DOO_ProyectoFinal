...
/** Un Equus zebra es un animal con una coloración a base de rayas blancas sobre un fondo negro, vive en la sabana y se puede adoptar
...
public class Cebra extends Animal {
    ...
    /** Constructor ue genera los números pseudoaleatorios para el movimiento y le entrega el tipo animal Cebra a la clase
     * @param nombre Nombre del animal tipo Cebra */
