...
/** Un Elephantidae es un animal amíferos placentarios del orden proboscideos, vive en la sabana (en este caso) y se puede adoptar
...
public class Elefante extends Animal {
    ...
    /** Constructor ue genera los números pseudoaleatorios para el movimiento y le entrega el tipo animal Elefante a la clase
     * @param nombre Nombre del animal tipo Elefante */
