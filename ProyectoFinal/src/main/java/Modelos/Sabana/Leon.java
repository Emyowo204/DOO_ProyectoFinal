...
/** Un Panthera leo es un animal mamífero carnívoro de la familia de los félidos, vive en la sabana y se puede adoptar
...
public class Leon extends Animal {
    ...
    /** Constructor ue genera los números pseudoaleatorios para el movimiento y le entrega el tipo animal León a la clase
     * @param nombre Nombre del animal tipo León */
