...
/** Una Giraffa camelopardalis es un animal mamífero artiodáctilo, siendo el más alto de todas las especies terrestres, vive en la sabana y se puede adoptar
...
public class Jirafa extends Animal {
    ...
    /** Constructor ue genera los números pseudoaleatorios para el movimiento y le entrega el tipo animal Jirafa a la clase
     * @param nombre Nombre del animal tipo Jirafa */
