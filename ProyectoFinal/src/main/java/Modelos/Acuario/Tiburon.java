...
/** Un Selachimorpha es un gran animal depredador, que tiene un esqueleto cartilaginoso y una boca ventral; es marino y se puede adoptar
...
public class Tiburon extends Animal {
    ...
    /** Constructor ue genera los números pseudoaleatorios para el movimiento y le entrega el tipo animal Tiburón a la clase
     * @param nombre Nombre del animal tipo Tiburón */
