...
/** Un Canis latrans es un animal mamífero carnívoro de la familia de los cánidos, vive en el desierto (en este caso) y se puede adoptar
...
public class Coyote extends Animal {
    ...
    /** Constructor ue genera los números pseudoaleatorios para el movimiento y le entrega el tipo animal Coyote a la clase
     * @param nombre Nombre del animal tipo Coyote */
