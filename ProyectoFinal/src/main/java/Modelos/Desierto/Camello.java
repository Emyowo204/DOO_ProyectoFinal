...
/** Un Camelus es un animal mamífero artiodáctilo de la familia Camelidae que incluye a las tres especies vivientes, vive en el desierto y se puede adoptar
...
public class Camello extends Animal {
    ...
    /** Constructor ue genera los números pseudoaleatorios para el movimiento y le entrega el tipo animal Camello a la clase
     * @param nombre Nombre del animal tipo Camello */
