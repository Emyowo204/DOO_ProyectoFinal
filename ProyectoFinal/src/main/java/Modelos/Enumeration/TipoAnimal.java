...
public enum TipoAnimal {
    ...
    Coipo(100, TipoHabitat.Acuatico, TipoComida.Arbustos,"Coipo"),
    Delfin(100, TipoHabitat.Acuatico, TipoComida.Pescado,"Delfín"),
    LoboMarino(100, TipoHabitat.Acuatico, TipoComida.Pescado,"Lobo marino"),
    Orca(100, TipoHabitat.Acuatico, TipoComida.CarneRoja,"Orca"),
    Tiburon(100, TipoHabitat.Acuatico, TipoComida.Pescado,"Tiburón"),
    Tortuga(100, TipoHabitat.Acuatico, TipoComida.Vegetacion,"Tortuga"),
