...
/** Un Psittacoidea es un animal tipo ave con un plumaje colorido que puede imitar sonidos, vive en la selva y se puede adoptar
...
public class Loro extends Animal {
    ...
    /** Constructor ue genera los números pseudoaleatorios para el movimiento y le entrega el tipo animal Loro a la clase
     * @param nombre Nombre del animal tipo Loro */
