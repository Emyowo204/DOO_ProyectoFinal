...
/** La Panthera es un género de animales mamíferos de la familia Felidae, vive en la selva y se puede adoptar
...
public class Pantera extends Animal {
    ...
    /** Constructor ue genera los números pseudoaleatorios para el movimiento y le entrega el tipo animal Pantera a la clase
     * @param nombre Nombre del animal tipo Pantera */
