...
/** Un Ursus maritimus es un animal blanco y mamífero carnívoro de la familia de los osos, vive en el ártico y se puede adoptar
...
public class OsoPolar extends Animal {
    ...
    /** Constructor ue genera los números pseudoaleatorios para el movimiento y le entrega el tipo animal Oso Polar a la clase
     * @param nombre Nombre del animal tipo Oso Polar */
     ...
     * @return Número entero que indica una probabilidad de 1 en 12 (8,3%) */
    @Override
