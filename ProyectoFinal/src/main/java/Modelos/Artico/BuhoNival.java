...
/** Un Bubo scandiacus es un animal blanco tipo ave estrigiforme de la familia Strigidae, vive en el ártico y se puede adoptar
...
public class BuhoNival extends Animal {
    ...
    /** Constructor ue genera los números pseudoaleatorios para el movimiento y le entrega el tipo animal Búho Nival a la clase
     * @param nombre Nombre del animal tipo Búho Nival */
